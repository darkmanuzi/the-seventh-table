(() => {
  ...
  const BRAND_TERMS = new Set([
    ...
    'THE SIGNATURE CIRCLE', 'The Signature Circle', 'SIGNATURE CIRCLE', 'Signature Circle',
    'Chefs of THE SEVENTH TABLE',
  ...
  const V26 = {
    de: {
      'A curated international circle recognising chefs who compose unforgettable dining experiences far beyond the plate.':'Ein kuratierter internationaler Kreis für Köche, die unvergessliche Dinner-Erlebnisse weit über den Teller hinaus gestalten.',
      'A Signature Reservation is not a playlist with a chef\'s name. It is an original musical world composed around the character, timing and atmosphere of a complete dining experience.':'Eine Signature Reservation ist keine Playlist mit dem Namen eines Kochs. Sie ist eine eigenständige musikalische Welt, komponiert für Charakter, Timing und Atmosphäre eines vollständigen Dinner-Erlebnisses.',
      'Enter The Signature Circle →':'The Signature Circle betreten →','First Signature in development':'Erste Signature in Entwicklung','Private Villa Dining · Algarve, Portugal':'Private Villa Dining · Algarve, Portugal','In Development':'In Entwicklung','The next Signature is yet to be composed.':'Die nächste Signature wartet noch darauf, komponiert zu werden.','The Circle remains intentionally small. Each new seat begins with a shared understanding of hospitality.':'Der Circle bleibt bewusst klein. Jeder neue Platz beginnt mit einem gemeinsamen Verständnis von Gastlichkeit.','Discover the Circle →':'Den Circle entdecken →',
      'A curated circle for chefs who understand that an unforgettable dining experience is composed far beyond the plate.':'Ein kuratierter Kreis für Köche, die verstehen, dass ein unvergessliches Dinner-Erlebnis weit über den Teller hinaus gestaltet wird.','The principles of The Signature Circle':'Die Prinzipien von The Signature Circle','The menu leads.':'Das Menü gibt die Richtung vor.','The music never competes with the plate. It follows the rhythm, character and intention of the chef\'s experience.':'Die Musik konkurriert nie mit dem Teller. Sie folgt Rhythmus, Charakter und Intention des Erlebnisses, das der Chef gestaltet.','The evening evolves.':'Der Abend entwickelt sich.','Arrival, dinner and after dinner become connected chapters of one deliberately composed journey.':'Ankunft, Dinner und After Dinner werden zu verbundenen Kapiteln einer bewusst komponierten Reise.','The Signature remains.':'Die Signature bleibt.','Each selected chef receives a dedicated place within the Circle and access to a musical world shaped for professional service.':'Jeder ausgewählte Chef erhält einen eigenen Platz im Circle und Zugang zu einer musikalischen Welt für den professionellen Service.','In Development':'In Entwicklung','A modular Signature Reservation created for the natural progression of private villa dining in the Algarve — warm Mediterranean arrival, understated dinner groove and a gradual return of energy after dessert.':'Eine modulare Signature Reservation für den natürlichen Verlauf eines Private Dinners in einer Algarve-Villa – warmer mediterraner Empfang, zurückhaltender Dinner-Groove und die allmähliche Rückkehr der Energie nach dem Dessert.','Curated by Invitation':'Kuratiert auf Einladung','Not a directory.\nA distinction.':'Kein Verzeichnis.\nEine Auszeichnung.','The Signature Circle is intentionally limited. Chefs are recognised for a shared belief in atmosphere, hospitality and the complete dining experience. Individual Signature access is private and becomes available only after personal invitation and activation.':'The Signature Circle ist bewusst limitiert. Ausgezeichnet werden Chefs, die an Atmosphäre, Gastlichkeit und das vollständige Dinner-Erlebnis glauben. Der individuelle Signature-Zugang ist privat und wird ausschließlich nach persönlicher Einladung und Freischaltung verfügbar.','Private Signature Access · Preparing the room':'Private Signature Access · Der Raum wird vorbereitet'
    },
    fr: {
      'A curated international circle recognising chefs who compose unforgettable dining experiences far beyond the plate.':'Un cercle international sélectionné pour les chefs qui composent des expériences inoubliables bien au-delà de l’assiette.','Enter The Signature Circle →':'Entrer dans The Signature Circle →','First Signature in development':'Première Signature en développement','In Development':'En développement','The next Signature is yet to be composed.':'La prochaine Signature reste à composer.','Discover the Circle →':'Découvrir le Circle →','A curated circle for chefs who understand that an unforgettable dining experience is composed far beyond the plate.':'Un cercle sélectionné pour les chefs qui savent qu’une expérience inoubliable se compose bien au-delà de l’assiette.','The menu leads.':'Le menu donne le ton.','The evening evolves.':'La soirée évolue.','The Signature remains.':'La Signature demeure.','Curated by Invitation':'Sélection sur invitation','Not a directory.\nA distinction.':'Pas un annuaire.\nUne distinction.','In Development':'En développement','Private Signature Access · Preparing the room':'Accès Signature privé · Le salon se prépare'
    },
    es: {
      'A curated international circle recognising chefs who compose unforgettable dining experiences far beyond the plate.':'Un círculo internacional cuidadosamente seleccionado para chefs que crean experiencias inolvidables mucho más allá del plato.','Enter The Signature Circle →':'Entrar en The Signature Circle →','First Signature in development':'Primera Signature en desarrollo','In Development':'En desarrollo','The next Signature is yet to be composed.':'La próxima Signature aún está por componer.','Discover the Circle →':'Descubrir el Circle →','A curated circle for chefs who understand that an unforgettable dining experience is composed far beyond the plate.':'Un círculo seleccionado para chefs que entienden que una experiencia inolvidable se compone mucho más allá del plato.','The menu leads.':'El menú marca el rumbo.','The evening evolves.':'La velada evoluciona.','The Signature remains.':'La Signature permanece.','Curated by Invitation':'Selección por invitación','Not a directory.\nA distinction.':'No es un directorio.\nEs una distinción.','In Development':'En desarrollo','Private Signature Access · Preparing the room':'Acceso Signature privado · Preparando la sala'
    }
  };
